...
def test_current_database_leagues_all_have_a_season_boundary_source():
    current_leagues = {
        "CONCACAF Nations League", "FFA Cup", "U20世界杯", "U23亚洲杯",
        "世界杯", "世界杯预选赛", "东亚锦标赛",
        "中北美金杯赛", "亚洲冠军乙级联赛", "亚洲冠军精英联赛",
        "俱乐部世界杯", "南美解放者杯", "国际赛", "女足东亚锦标赛",
        "女足世界杯", "女足亚洲杯", "巴西甲级联赛", "德国乙级联赛", "德国杯",
        "德国甲级联赛", "德国超级杯", "意大利杯", "意大利甲级联赛",
        "意大利超级杯", "挪威超级联赛", "日本乙级联赛", "日本天皇杯",
        "日本职业联赛", "日本联赛杯", "杯赛", "欧洲冠军联赛",
        "欧洲协会联赛", "欧洲超级杯", "欧罗巴联赛", "沙特职业联赛",
        "法国乙级联赛", "法国杯", "法国甲级联赛", "澳大利亚超级联赛",
        "瑞典超级联赛", "美国职业大联盟", "芬兰超级联赛",
        "英格兰冠军联赛", "英格兰甲级联赛", "英格兰社区盾杯",
        "英格兰联赛杯", "英格兰超级联赛", "英格兰足总杯",
        "英格兰锦标赛", "荷兰乙级联赛", "荷兰杯", "荷兰甲级联赛",
        "葡萄牙超级联赛", "西班牙国王杯", "西班牙甲级联赛",
        "西班牙超级杯", "非洲杯", "韩国杯", "韩国职业联赛",
        "中北美冠军杯", "亚洲杯", "亚运会女足", "亚运会男足",
        "俄罗斯超级联赛", "奥运会女足", "奥运会男足", "巴西杯",
        "挪威杯", "欧洲U21锦标赛", "欧洲国家联赛", "欧洲杯",
        "欧洲杯预选赛", "瑞典杯", "美国公开赛杯", "美洲杯", "葡萄牙杯",
    }
