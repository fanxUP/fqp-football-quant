  ...
  return (
    <div>
      ...
      <Card style={{ marginBottom: '20px' }}>
        ...
        {selectedMatch && (
          <div style={{ marginTop: 12, display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap', fontSize: 13, color: 'var(--fqp-text-muted)' }}>
            <span>{selectedMatch.league_name} ·</span><TeamName name={selectedMatch.home_team_name} size={18} /><span>vs</span><TeamName name={selectedMatch.away_team_name} size={18} />
            <span>· {String(selectedMatch.kickoff_time).replace('T', ' ').slice(0, 16)}</span>
          </div>
        )}
      </Card>
