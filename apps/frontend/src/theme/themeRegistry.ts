...
export const THEME_REGISTRY: ThemeDefinition[] = [
  ...
  {
    id: 'graphite-minimal', name: '石墨极简', description: '高密度、低干扰的专业工作台', category: 'professional', mode: 'dark', available: true,
    preview: { background: '#111315', surface: '#1A1D20', primary: '#6EA8FE', secondary: '#4FC38A' }, defaults: { ...defaults, cardStyle: 'flat' },
  },
  {
    id: 'crimson-arena', name: '赤焰竞技', description: '面向比赛日的夜间球场氛围', category: 'football', mode: 'dark', available: true,
    preview: { background: '#09090B', surface: '#111216', primary: '#C91D2E', secondary: '#35C990' }, defaults,
  },
  {
    id: 'tactical-board', name: '绿茵战术板', description: '阵型、球员和比赛理解工作台', category: 'football', mode: 'dark', available: true,
    preview: { background: '#07120D', surface: '#0D1D15', primary: '#74D680', secondary: '#C9F36B' }, defaults,
  },
  {
    id: 'global-match-center', name: '全球赛事中心', description: '适合赛事日和大屏的转播包装', category: 'football', mode: 'dark', available: true,
    preview: { background: '#07101E', surface: '#0D1A2C', primary: '#235BC8', secondary: '#D1AA58' }, defaults,
  },
  {
    id: 'quantum-forecast', name: '未来预测引擎', description: '突出模型流程和概率分布的 AI 主题', category: 'future', mode: 'dark', available: true,
    preview: { background: '#070817', surface: '#101329', primary: '#3D7EFF', secondary: '#8B5CF6' }, defaults,
  },
  {
    id: 'neon-grid', name: '赛博朋克', description: '克制霓虹的数据网络和自动化界面', category: 'future', mode: 'dark', available: true,
  ...
  {
    id: 'code-matrix', name: '代码矩阵', description: '面向采集、任务和日志的终端主题', category: 'future', mode: 'dark', available: true,
  ...
  {
    id: 'anime-striker', name: '次元前锋', description: '未来学院风的轻度游戏化足球主题', category: 'personal', mode: 'dark', available: true,
