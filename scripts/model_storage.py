...
def store_model_prediction(conn: Any, pred: dict) -> int | None:
    ...
    sql = """
        INSERT INTO model_predictions (
            match_id, model_version_id, odds_snapshot_id, predict_time,
            ...
            %(match_id)s, %(model_version_id)s, %(odds_snapshot_id)s, %(predict_time)s,
        ...
        for item in items:
            cur.execute(
                ...
                INSERT INTO simulation_ticket_items (
                    ...
                    %(ticket_id)s, %(match_id)s, %(odds_snapshot_id)s, %(model_prediction_id)s,
