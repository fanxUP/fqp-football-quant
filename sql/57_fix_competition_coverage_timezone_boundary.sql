-- Competition season dates are provider/venue-local, while official Sporttery
-- kickoff timestamps are stored in China local time. A match near midnight can
-- therefore cross a calendar boundary, as the 2026 World Cup final does.
...
LEFT JOIN event_match_catalog emc
 ...
 AND emc.kickoff_time::date
     BETWEEN s.start_date - INTERVAL '1 day'
