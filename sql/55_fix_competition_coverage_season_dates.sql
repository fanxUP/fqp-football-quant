-- Competition season codes may be provider-qualified values such as
-- "apifootball:71:2026". Match official events by the canonical season date
-- interval instead of assuming the display code is an integer year.
